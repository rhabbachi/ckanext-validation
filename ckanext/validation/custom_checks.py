                    ...
                    if len(column_numbers) == 1:
                        ...
                        error = Error(
                            ...
                            message='Rows {row_numbers} have a composite uniqueness constraint violation. '
                                    'Primary key fields ({primary_key_fields}) must form a unique combination in the dataset.',
                            message_substitutions=message_substitutions
                        )
                    # End Custom code =========================================
                    errors.append(error)
        ...
        "errors": {
            ...
            "extra-value": {
                ...
                "description": _("This row has more values compared to the header row (the first row in the data source). '\
                    'A key concept is that all the rows in tabular data must have the same number of columns.'\
            ...
            "schema-error": {
                ...
                "description": _("Provided schema is not valid.\n\n How it could be resolved:'\
                    ...
                    'ignored disable schema checks in {validator}."),
            },
            "non-matching-header": {
            ...
            "extra-header": {
                ...
                "description": _("The first row of the data source contains header that doesn't exist in the schema.'\
                    '\n\n How it could be resolved:\n - Remove the extra column from the data source or add the missing '\
            ...
            "type-or-format-error": {
                ...
                "context": "body",
                "weight": 9,
                "message": _("The value {value} in row {row_number} and column {column_number} is not type '\
                    '{field_type} and format {field_format}"),
            ...
            "enumerable-constraint": {
                ...
                "context": "body",
                "weight": 7,
                "message": _("The value {value} in row {row_number} and column {column_number} is not found in '\
                    'the list of valid values for this field: {constraint}"),
            ...
            "minimum-constraint": {
                ...
                "context": "body",
                "weight": 7,
                "message": _("The value {value} in row {row_number} and column {column_number} does not conform to the minimum '\
            ...
            "maximum-constraint": {
                ...
                "context": "body",
                "weight": 7,
                "message": _("The value {value} in row {row_number} and column {column_number} does not conform to the maximum '\
                    'constraint of {constraint}"),
            ...
            "foreign-key": {
                ...
                "context": "body",
                "weight": 7,
                "message": _("Value in column {column_number} and row {row_number} is not found '\
                    'in the referenced data table: {resource_id}"),
                "description": _("Area IDs must match those from the referenced location hierachy. '\
                    'Please check the location hierachy.")
            }
        }
    }
